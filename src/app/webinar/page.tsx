    ...
    return (
        <div className={styles.webinar_main}>
            <div className={styles.sections}>
                <a href="#event" className={styles.arrowButton}><div><svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className={styles.intro}>
                    <div className={styles.introContainer}>
                        ...
                        <h1>How to build your first AI Agent</h1>
                        ...
                        <div className={styles.introEventContainer}>
                            ...
                            <p>The "How to build your first AI Agent" event will cover speech recognition, NLP, and text-to-speech. Attendees will learn how to process voice input, interpret it using AI models, and generate voice responses. </p>
                        </div>
                    </div>
            ...
            <div id="event" className={styles.eventDetail}>
                <h3>Event in Detail</h3>
                <p>The "How to build your first AI Agent" event aims to introduce participants to voice-based AI technology and guide them through the process of creating an AI agent that can understand and respond to spoken language. The session will cover fundamental concepts of voice recognition, natural language processing (NLP), and text-to-speech (TTS) technologies, offering hands-on development experience using tools like Python, Google’s Speech-to-Text API, and speech synthesis libraries.Whether developing for smart assistants, customer service bots, or automated voice systems, attendees will leave with a functional voice AI agent and a solid foundation in voice interaction technologies. </p>
                <p>The session will conclude with a live demo, troubleshooting tips, and guidance on how to enhance and deploy their agents in real-world applications. Ideal for developers and AI enthusiasts, this workshop will equip attendees with the tools to build and expand voice-driven AI solutions.</p>
            </div>

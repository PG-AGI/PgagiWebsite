...
import styles from "@/styles/app/jobs/[jobId]/JobDetailsPage.module.scss";
import SkeletonLoader from "../components/SkeletonLoader";
import { fetchJobPostingById } from "@/services/careersService";
...
const JobDetailsPage = ({ params }: { params: { jobId: string } }) => {
  ...
  useEffect(() => {
    async function fetchJobDetails() {
      try {
        ...
        const job: Job = await fetchJobPostingById(jobId);
        setJob(job);
        setIsLoading(false);
      } catch (err) {
        setError(
  ...
  const handleApplicationSubmit = (formData: JobApplicationData) => {

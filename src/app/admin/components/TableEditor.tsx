...
import adminTableEditorText from '@/constants/uiText/adminTableEditor.json';
...
useEffect(() => {
  if (
    ...
    setRows(value.rows);
    setColumns(value.headers.length);
  }
}, [value]);
                ...
                <div className={styles.headerWrapper}>
                  ...
                  {columns > 1 && (
                    <button
                      ...
                      title={adminTableEditorText.deleteColumnTitle}
                    >
                      ×
                    </button>
                  )}
              ...
              <td className={styles.tableEditorTd}>
                {rows.length > 1 && (
                  <button
                    ...
                    title={adminTableEditorText.deleteRowTitle}
                  >
                    ×
                  </button>
                )}

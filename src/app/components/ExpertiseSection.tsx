      ...
      <div className={styles.container}>
        ...
        <div className={styles.expertiseContent}>
          ...
          <p className={styles.expertiseDescription}>
            We partner with bold founders to build end-to-end AI products that
            truly matter to users. Our expertise spans from designing and
            developing AI-driven products to delivering enterprise-grade
        ...
        <div className={styles.bottomSection}>
          ...
          <div className={styles.sloganSection}>
            ...
            <p className={styles.description}>
              No big words. No bloated pitch decks. No five-hour Zoom calls.
              Just smart strategy, flawless execution and results that actually
              move the needle.
            </p>
          </div>

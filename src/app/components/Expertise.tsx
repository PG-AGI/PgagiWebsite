    ...
    () => [
      {
        ...
        tagline: "Where Brands Come Alive",
        description:
          "Where brands come alive. We craft identities that don't just look good they mean something. From strategy to storytelling, we help brands show up with confidence, clarity, and a whole lot of personality. Whether you're building from scratch or ready for a rebrand, we'll make sure every detail reflects who you are and where you're headed.",
        services: [
          "Brand Strategy & Positioning",
          "Visual Identity Design",
          "Brand Voice & Messaging",
      ...
      },
      {
        ...
        tagline: "From Concept to Home Screen",
        description:
          "We transform ideas into intuitive, powerful mobile experiences. From native iOS and Android development to cross-platform solutions, we build apps that users love and businesses rely on. Our mobile expertise covers everything from concept to launch, ensuring your app stands out in crowded app stores.",
        services: [
          "Native iOS Development",
          "Native Android Development",
          "Cross-Platform Solutions",
      ...
      },
      {
        ...
        tagline: "Websites that work as good as they look",
        description:
          "From polished marketing sites to dynamic, content-rich platforms, our dev team turns bold ideas into seamless digital experiences. Designed for speed, built for scale, and engineered to convert. Our websites don't just exist online, they perform.",
        services: [
          "Custom Front-End Development",
          "Framer & No-Code Development",
          "E-commerce Development",
      ...
      },
      {
        ...
        tagline: "Intelligence That Drives Innovation",
        description:
          "We harness the power of artificial intelligence to solve complex business challenges. From custom AI models to intelligent automation, we help businesses leverage cutting-edge technology to gain competitive advantages and unlock new possibilities.",
        services: [
          "Custom AI Models",
          "Natural Language Processing",
          "Computer Vision",
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <h1 className={styles.mainTitle}>
            <span className={styles.titleLine1}>
              We build the stuff brands brag about.
            </span>
            <span className={styles.titleLine2}>
              Bold identities, beautiful websites, scroll stopping campaigns and
              digital experiences people actually love.
            </span>
          </h1>
        </motion.div>
        ...
        <div className={styles.mainContent}>
          ...
          >
            <div className={styles.leftContent}>
              <p className={styles.leftText}>
                Craft the Brand They
                <br />
                Remember. Move Faster
                <br />
                Than They Can Follow.
              </p>
              <div className={styles.dot}></div>

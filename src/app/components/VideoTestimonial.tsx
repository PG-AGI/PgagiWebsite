...
const testimonials: Testimonial[] = [
  {
    ...
    country: "USA",
    quote:
      "From day one, I was given expert analysis of our custom trained model. I don't know of many others that will walk you through data processing, model training, and endpoint deployment with such ease and expertise.",
    projectName: "VertexCast AI – Forecasting future trends with Vertex AI",
  },
  {
    name: "Nicholas",
    ...
    country: "Canada",
    quote:
      "Awesome service, sometimes takes more time than expected but they worked very hard and a very complicated project and never gave up.",
    projectName: "SportBetting ML Project",
  },
  {
    name: "San Dev",
              ...
              >
                ...
                >
                  ...
                  <p className={styles.speakerTitle}>
                    ...
                    AI-powered communication system. Automated WhatsApp
                    outreach, intelligent conversational AI calls, and seamless
                ...
                >
                  ...
                  <div className={styles.authorInfo}>
                    ...
                    <div className={styles.authorDetails}>
                      <div className={styles.authorNameRow}>
                        <h4 className={styles.authorName}>
                          {nextTestimonial.name || nextTestimonial.company}
                        </h4>
                        <StarRating />
                      </div>
                      <p className={styles.authorTitle}>

...
import styles from "@/styles/components/organisms/BuildEcosystemSection.module.scss";
import {
  FRAMER_EASE,
  GSAP_EASE,
  MOBILE_BREAKPOINT,
...
import buildEcosystemSectionText from "@/constants/uiText/buildEcosystemSection.json";
  ...
  return (
    <section ref={sectionRef} className={styles.section} id="build-ecosystem">
      <div className={styles.container}>
        ...
        >
          {buildEcosystemSectionText.titlePrefix} <span>{buildEcosystemSectionText.titleHighlight}</span>
        </motion.h2>

...
//     console.log('HyperSpeed component mounting...');
    
//     if (appRef.current) {
//       console.log('Disposing previous app instance');
...
//     console.log('Container found, initializing HyperSpeed app...');
...
//       console.log('App created, loading assets...');
//       myApp.loadAssets().then(() => {
//         console.log('Assets loaded, initializing...');
//         myApp.init();
//         console.log('HyperSpeed app initialized successfully');
//       }).catch(error => {
//         console.error('Error loading assets:', error);
//       });
//     } catch (error) {
//       console.error('Error creating HyperSpeed app:', error);
//     }

//     return () => {
//       console.log('HyperSpeed component unmounting...');
//       if (appRef.current) {
//         appRef.current.dispose();
//       }
//     };
...
import '@/styles/components/organisms/ui/Hyperspeed/Hyperspeed.css';
...
class CarLights {
  ...
  init() {
    ...
    if (geometry.index) {
      instanced.setIndex(geometry.index.clone());
    }
    Object.entries(geometry.attributes).forEach(([name, attribute]) => {
      instanced.setAttribute(name, attribute.clone());
    });
    instanced.instanceCount = options.lightPairsPerRoadWay * 2;

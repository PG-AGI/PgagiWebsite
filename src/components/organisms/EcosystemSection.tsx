...
import styles from "@/styles/components/organisms/EcosystemSection.module.scss";
import { GSAP_EASE, MOTION_DURATION, MOTION_STAGGER } from "@/lib/motion";
import ecosystemSectionText from "@/constants/uiText/ecosystemSection.json";
...
const ecosystemCards: EcosystemCard[] = [
  {
    title: ecosystemSectionText.cards[0].title,
    image: "/svgs/Ecosystem/First.svg",
    width: 331,
    height: 794,
  },
  {
    title: ecosystemSectionText.cards[1].title,
    image: "/svgs/Ecosystem/Second.svg",
    width: 333,
    height: 735,
  },
  {
    title: ecosystemSectionText.cards[2].title,
    ...
    <>
      ...
      <section className={styles.section} id="ecosystem" ref={sectionRef}>
        <div className={styles.container}>
          <h2 className={styles.title} ref={titleRef}>{ecosystemSectionText.titlePrefix} <span>{ecosystemSectionText.titleHighlight}</span></h2>
      ...
      <div className={styles.pinWrapper} id="ecosystem-mobile">
        <div className={styles.pinInner}>
          <div className={styles.mobileContainer}>
            <h2 className={styles.mobileTitle}>{ecosystemSectionText.titlePrefix} <span>{ecosystemSectionText.titleHighlight}</span></h2>
              ...
              <div className={styles.scrollDots}>
                {ecosystemCards.map((_, i) => (
                  <button
                    ...
                    aria-label={`${ecosystemSectionText.goToPanelAriaPrefix} ${i + 1}`}
                  />
                ))}
              </div>
            </div>

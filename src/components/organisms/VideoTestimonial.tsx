...
import styles from "@/styles/components/organisms/VideoTestimonial.module.scss";
import Image from "next/image";
import videoTestimonialText from "@/constants/uiText/videoTestimonial.json";
...
const videos: VideoData[] = [
  {
    ...
    title: videoTestimonialText.videos[0].title,
    description: videoTestimonialText.videos[0].description,
  },
  {
    ...
    title: videoTestimonialText.videos[1].title,
    description: videoTestimonialText.videos[1].description,
  },
];
      ...
      <div className={styles.container}>
        ...
        <div className={styles.headerSection}>
          <div className={styles.centeredHeader}>
            <h3 className={styles.testimonialLabel}>{videoTestimonialText.testimonialLabel}</h3>
            <p className={styles.subtitle}>{videoTestimonialText.subtitle}</p>
          </div>
        </div>
        ...
        >
          ...
          {(
            <>
              <button
                ...
                aria-label={videoTestimonialText.previousAriaLabel}
              >
              ...
              <button
                ...
                aria-label={videoTestimonialText.nextAriaLabel}
              >
                <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
              ...
              {duplicatedImages.map((image, index) => (
                <div key={`testimonial-${index}`} className={styles.testimonialCard}>
                  <Image
                    ...
                    width={480}
                    height={300}
                    sizes="(max-width: 480px) calc(100vw - 3rem), (max-width: 768px) 320px, (max-width: 1024px) 380px, (max-width: 1200px) 420px, 480px"
                  />
                </div>
              ))}
            </div>
          ...
          {testimonialImages.length === 0 && (
            <div style={{ padding: "2rem", textAlign: "center", color: "#999" }}>
              {videoTestimonialText.noImagesMessage}
            </div>
          )}
        </div>
          ...
          >
            ...
            >
              ...
              <button
                ...
                onClick={closeVideo}
                aria-label={videoTestimonialText.closeVideoAriaLabel}
              >
                ✕
              </button>
            </div>
